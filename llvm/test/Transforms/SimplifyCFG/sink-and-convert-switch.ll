...
; Both arms shift by a different constant. Sinking the shifts replaces the
; immediates with a PHI of shift amounts and a variable shift, which is worse
; than the two immediate shifts.
...
; The same pair of shifts in a diamond.
...
; into a lookup, which is worth the variable shift.
